# -*- mode: conf-unix; -*-
# @falaise:config/snemo/demonstrator/geometry/4.1/models/half_module_commissioning.geom
...
#@variant_only geometry:layout/if_half_commissioning/granularity/if_low|true
grid.z.number_of_items : integer =   3

#@variant_only geometry:layout/if_half_commissioning/granularity/if_high|false
grid.z.number_of_items : integer =  13
...
#@variant_only geometry:layout/if_half_commissioning/granularity/if_high|false
grid.z.step : real as length = 26 cm
...
# end of @falaise:config/snemo/demonstrator/geometry/4.1/models/half_module_commissioning.model.geom
