#!/usr/bin/env bash
# hc_launch_data_quality.sh

APP_NAME=hc_launch_data_quality.sh
debug=1

echo "Starting..." >&2

SW_PATH="/home/goliviero/software/Falaise/build/BuildProducts/bin/"
SW_NAME="fecom-hc_data_quality"

function usage(){
echo "--------------"
echo "Goal : Analyze half commissioning raw data"
echo "--------------"
echo "How to use it"
echo " "
...
### PATH TO ADAPT : ###
INPUT_DIR="/data/nemo/group/Private/goliviero/data_half_commissioning/"
...
ANALYZED_OUTPUT_PATH="${OUTPUT_PATH}/analyzed/Run_${run_number}/"
...
SERIALIZED_ROOT_DATA_FORMAT_PATH="${OUTPUT_PATH}/root/Run_${run_number}/"
