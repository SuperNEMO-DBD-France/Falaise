...
namespace snemo {
  ...
  namespace digitization {
    ...
    const trigger_structures::calo_summary_record calo_trigger_algorithm::get_calo_level_1_finale_decision_structure() const
    {
    ...
    void calo_trigger_algorithm::_display_calo_summary(trigger_structures::calo_summary_record & my_calo_summary_record_)
    {
    ...
    void calo_trigger_algorithm::_build_calo_record_summary_structure(trigger_structures::calo_summary_record & my_calo_summary_record_)
    {
    ...
    void calo_trigger_algorithm::_compute_calo_finale_decision(trigger_structures::calo_summary_record & my_calo_summary_record_)
    {
