...
function usage(){
echo "--------------"
echo "Goal : Produce self trigger hits and pack them into events @ 1600 ns at CCLYON."
echo "--------------"
echo "How to use it"
echo " "
...
echo "--------------"
echo "Example : "
echo "./self_trigger_script_lyon -r 0"
echo " "
}
...
st_time_interval=1 # s
st_calo_freq=1 # Hz
st_tracker_freq=1 # Hz
